package online.nasgar.survival.tab.nms.v1_7_R4;
...
import online.nasgar.survival.tab.utils.LegacyClient;
...
public class Tab_v1_7_R4 implements TabNMS {
    ...
    public void updateHeaderAndFooter(Player player, List<String> header, List<String> footer) {
        IChatBaseComponent headerComponent = ChatSerializer.a("{text:\"" + StringEscapeUtils.escapeJava(this.getListFromString(ChatUtil.translate(header)))  + "\"}");
        IChatBaseComponent footerComponent = ChatSerializer.a("{text:\"" + StringEscapeUtils.escapeJava(this.getListFromString(ChatUtil.translate(footer))) + "\"}");
